                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-sample" action="{{ url('admin/add-images/' . $product['id']) }}"
                                method="post" enctype="multipart/form-data"> {{-- "enctype" attribute must be used becasue we're uploading files --}}
                                @csrf
                            ...
                            <table id="products" class="table table-bordered"> {{-- using the id here for the DataTable --}}
                                ...
                                <tbody>
                                    @foreach ($product['images'] as $image)
                                        {{-- using the relationship 'images' --}}<tr>
                                            <td>{{ $image['id'] }}</td>
                                            <td>
                                                <img
                                            ...
                                            <td>
                                                ...
                                                <a href="JavaScript:void(0)" class="confirmDelete" module="image"
                                                    moduleid="{{ $image['id'] }}"> {{-- Check admin/js/custom.js and web.php (routes) --}}
