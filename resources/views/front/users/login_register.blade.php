                ...
                <div class="reg-wrapper">
                    ...
                    <form id="registerForm" action="{{ url('/user/register') }}" method="post">
                        ...
                        <div class="u-s-m-b-30">
                            ...
                            <input type="text" id="user-name" class="text-field" placeholder="Customer Name" name="name">
                            <p id="register-name"></p>
                        </div>
                        <div class="u-s-m-b-30">
                            <label for="usermobile">Phone Number
                                <span class="astk">*</span>
                            </label>
                            <input type="text" id="user-mobile" class="text-field" placeholder="Customer Phone Number" name="mobile">
                        ...
                        <div class="u-s-m-b-30">
                            ...
                            <input type="email" id="user-email" class="text-field" placeholder="Customer Email" name="email">
                        ...
                        <div class="u-s-m-b-30">
                            ...
                            <input type="password" id="user-password" class="text-field" placeholder="Customer Password" name="password">
