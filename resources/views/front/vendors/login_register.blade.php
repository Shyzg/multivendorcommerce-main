                ...
                <div class="login-wrapper">
                    ...
                    <form action="{{ url('admin/login') }}" method="post">
                        ...
                        <div class="u-s-m-b-30">
                            ...
                            <input type="password" name="password" id="vendor-password" class="text-field" placeholder="Vendor Password">
                        </div>
                        <div class="m-b-45">
            ...
            <div class="col-lg-6">
                <div class="reg-wrapper">
                    ...
                    <form id="vendorForm" action="{{ url('/vendor/register') }}" method="post">
                        ...
                        <div class="u-s-m-b-30">
                            <label for="vendormobile">Phone Number
                                <span class="astk">*</span>
                            </label>
                            <input type="text" id="vendormobile" class="text-field" placeholder="Vendor Phone Number" name="mobile">
                        </div>
                        <div class="u-s-m-b-30">
