                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <form name="checkoutForm" id="checkoutForm" action="{{ url('/checkout') }}" method="post">
                            ...
                            <br>
                            @endif
                            <h4 class="section-h4">Kurir Pengiriman</h4>
                            ...
                            <div class="order-table">
                                <table class="u-s-m-b-13">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <h6 class="order-h6">Ongkos Kirim</h6>
                                            </td>
                                            <td>
                                                <h6 class="order-h6">
                                ...
                                <button type="submit" id="placeOrder" class="button button-outline-secondary">Lanjut Bayar</button>
                            </div>
                        </form>
                    </div>
                </div>
