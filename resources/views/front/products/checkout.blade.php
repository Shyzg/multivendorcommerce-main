                                    ...
                                    @foreach ($deliveryAddresses as $address)
                                        <div class="control-group" style="float: left; margin-right: 5px">
                                            <input type="radio" id="address{{ $address['id'] }}" name="address_id"
                                                ...
                                                total_price="{{ $total_price }}" checked>
                                        </div>
                                        <div>
                                            ...
                                            <a href="javascript:;" data-addressid="{{ $address['id'] }}"
                                                class="editAddress" style="float: right">Edit</a>
                                        </div>
                                    @endforeach
                                    <br>
                                @endif
                                    ...
                                    <table class="u-s-m-b-13">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h6 class="order-h6">
                                                        <input class="text-field" type="hidden" id="shipping_charges"
                                                            name="shipping_charges" value="">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h3 class="order-h3">
                                                        <input class="text-field" type="hidden" id="price_static"
                                                            name="price"
                                                            value="{{ $total_price - \Illuminate\Support\Facades\Session::get('couponAmount') }}">
                                                        <input class="text-field" type="hidden" id="grand_total"
